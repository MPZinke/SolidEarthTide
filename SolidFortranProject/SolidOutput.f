...
*** position of observing point (positive East)
      ...
      gla0=glad/rad
      write(*, '(a,f32.16)') 'solid::gla0',gla0
      glo0=glod/rad
      write(*, '(a,f32.16)') 'solid::glo0',glo0
      eht0=0.d0
      write(*, '(a,f32.16)') 'solid::eht0',eht0
      call geoxyz(gla0,glo0,eht0,x0,y0,z0)
      xsta(1)=x0
      write(*, '(a,f32.16)') 'solid::xsta(1)',xsta(1)
      xsta(2)=y0
      write(*, '(a,f32.16)') 'solid::xsta(2)',xsta(2)
      xsta(3)=z0
      write(*, '(a,f32.16)') 'solid::xsta(3)',xsta(3)
...
*** operation confirmed for leap years (incl. year 2000)
      ...
      rjd=mjd+fmjd+2400000.5d0
      write(*, '(a,f32.16)') 'mjdciv::rjd: ',rjd
      ia=(rjd+0.5d0)
      write(*, '(a,i10)') 'mjdciv::ia: ',ia
      ib=ia+1537
      write(*, '(a,i10)') 'mjdciv::ib: ',ib
      ic=(ib-122.1d0)/365.25d0
      write(*, '(a,i10)') 'mjdciv::ic: ',ic
      id=365.25d0*ic
      write(*, '(a,i10)') 'mjdciv::id: ',id
      ie=(ib-id)/30.6001d0
      write(*, '(a,i10)') 'mjdciv::ie: ',ie

*** the fractional part of a julian day is fractional mjd + 0.5
*** therefore, fractional part of julian day + 0.5 is fractional mjd

      it1=ie*30.6001d0
      write(*, '(a,i10)') 'mjdciv::it1: ',it1
      idy=ib-id-it1+fmjd
      write(*, '(a,i10)') 'mjdciv::idy: ',idy
      it2=ie/14.d0
      write(*, '(a,i10)') 'mjdciv::it2: ',it2
      imo=ie-1-12*it2
      write(*, '(a,i10)') 'mjdciv::imo: ',imo
      it3=(7+imo)/10.d0
      write(*, '(a,i10)') 'mjdciv::it3: ',it3
      iyr=ic-4715-it3
      write(*, '(a,i10)') 'mjdciv::iyr: ',iyr

      tmp=fmjd*24.d0
      write(*, '(a,f32.16)') 'mjdciv::tmp: ',tmp
      ihr=tmp
      write(*, '(a,i10)') 'mjdciv::ihr: ',ihr
      tmp=(tmp-ihr)*60.d0
      write(*, '(a,f32.16)') 'mjdciv::tmp: ',tmp
      imn=tmp
      write(*, '(a,i10)') 'mjdciv::imn: ',imn
      sec=(tmp-imn)*60.d0
      write(*, '(a,f32.16)') 'mjdciv::sec: ',sec
